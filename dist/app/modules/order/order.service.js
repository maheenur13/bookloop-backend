...
const createOrder = orderData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sellerData = yield user_model_1.UserModel.findById(
    ...
    try {
      if (buyerData && cowData && sellerData) {
        ...
        yield user_model_1.UserModel.findByIdAndUpdate(
          buyerData._id,
          newBuyerData
        );
        yield user_model_1.UserModel.findByIdAndUpdate(
        ...
        newOrder = (yield (yield order_model_1.OrderModel.create(
          orderData
...
const getSingleOrder = (orderId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id, role } = payload;
    let query = {};
    if (role === 'buyer') {
