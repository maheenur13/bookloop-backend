...
const createCow = cowData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newCow = (yield cow_model_1.CowModel.create(cowData)).populate(
      'seller'
    );
    return newCow;
  });
// get all cow
const getAllCow = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filters,
      filtersData = __rest(filters, ['searchTerm']);
    const { page, limit, skip, sortBy, sortOrder } =
      pagination_helpers_1.paginationHelpers.calculatePagination(
        paginationOptions
      );
    const andConditions = [];
    if (searchTerm) {
...
// delete cow
const deleteCow = (userData, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cow_model_1.CowModel.isCowExistBySellerId(
      id,
      userData.id
    );
    if (!isExist) {
...
// update single cow
const updateCow = (userData, id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cow_model_1.CowModel.isCowExistBySellerId(
      id,
      userData.id
    ...
    const result = yield cow_model_1.CowModel.findByIdAndUpdate(
      id,
      updatedUserData,
      {
        new: true,
