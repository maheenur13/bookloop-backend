...
const loginUser = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.UserModel.isUserExistByPhone(
      phoneNumber
    );
    if (!isUserExist) {
      throw new ApiError_1.default(
    ...
    if (
      ...
      !(yield user_model_1.UserModel.isPasswordMatched(
        password,
        isUserExist.password
      ))
    ) {
...
const refreshToken = token =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      verifiedToken = jwt_helpers_1.jwtHelpers.verifyToken(
        token,
        config_1.default.jwt.refresh_secret
      );
    } catch (err) {
