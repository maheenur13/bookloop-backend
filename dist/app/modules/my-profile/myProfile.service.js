...
const getProfileDetails = userData =>
...
const updateProfile = (id, role, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (password) {
      newPassword = yield bcrypt_1.default.hash(
        password,
    ...
    if (role !== 'admin') {
      result = yield user_model_1.UserModel.findOneAndUpdate(
        { _id: id },
        updatedProfileData,
        {
          new: true,
      ...
      result = yield admin_model_1.AdminModel.findOneAndUpdate(
        { _id: id },
        updatedProfileData,
        {
          new: true,
