...
const createAdmin = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExist = yield admin_model_1.AdminModel.isAdminExistByPhone(
      data.phoneNumber
    );
    if (isExist) {
...
const loginAdmin = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield admin_model_1.AdminModel.isAdminExistByPhone(
      phoneNumber
    );
    if (!isUserExist) {
      throw new ApiError_1.default(
    ...
    if (
      ...
      !(yield admin_model_1.AdminModel.isPasswordMatched(
        password,
        isUserExist.password
      ))
    ) {
    ...
    const refreshToken = jwt_helpers_1.jwtHelpers.createToken(
      { id: _id, role },
